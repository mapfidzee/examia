    ...
    <main style={styles.page}>
      <div style={styles.container}>
        <section style={styles.header}>
          ...
          <h1 style={styles.title}>Executive Continuity Situation Room</h1>
        ...
        <section style={styles.heroCard}>
          ...
          <div style={styles.statusBox}>
            ...
            <p style={styles.statusQuestion}>{briefing.coreQuestion}</p>
          </div>
        </section>
        ...
        <section style={styles.gridThree}>
          <Panel title="Command Center">
            Leadership should coordinate stabilization, require evidence, and
            keep continuity protection visible until credibility improves.
          </Panel>
...
function SituationItem({ title, body }: { title: string; body: string }) {
  return (
